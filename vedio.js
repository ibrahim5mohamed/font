			$(document).ready(function () {
				...
				function playVid() {
					if (video.get(0).paused) {
						video.get(0).play();
						playIcon.css({
						   'background': 'url(//1.bp.blogspot.com/-gLkWtSaf-tU/XIlNFhMHzwI/AAAAAAAAM9s/o_ZTGOHYufI9ZmC6epzZla1gbwva1D1cQCK4BGAYYCw/s1600/pause.png)',
						...
						video.get(0).pause();
						playIcon.css({
						   'background': 'url(//4.bp.blogspot.com/-ifTv6CtwS1w/XIlNFoU6bmI/AAAAAAAAM9k/LJICQbE1TTE9y8unyEk-qGgy7JqYWKc4wCK4BGAYYCw/s1600/play.png)',
						   'background-size': '100% 100%'
						});
						overlayScreen.show();
				...
				function updateplayer() {
					...
					if (video[0].ended) {
						...
						overlayScreen.show();
						overlayButton.css({
						   'background': 'url(//2.bp.blogspot.com/-gee5rZfuvbY/XIlNF3NnCTI/AAAAAAAAM90/8xReiNINWL4ZG5OEtvcfacNWMVA0MpDugCK4BGAYYCw/s1600/replay.png)',
						   'background-size': '100% 100%'
						});
					} else if (video[0].paused) {
						overlayButton.css({
						   'background': 'url(//1.bp.blogspot.com/-2UDLEHIScUo/XIlNFjvnxrI/AAAAAAAAM98/63LAFYdE0S0w9u764ZdqVraI_CM9slybgCK4BGAYYCw/s1600/play-button.png)',
						   'background-size': '100% 100%'
						});
					}
				}
				...
				function toggleMute() {
					if (!video[0].muted) {
					   video[0].muted = true;
					   volume.css({
						  'background': 'url(//2.bp.blogspot.com/-wCbg41x6iCk/XIlNFhAIE6I/AAAAAAAAM94/Y9TWLKrZJgM1PSvjVsdk0BDwJf5Zi0zpgCK4BGAYYCw/s1600/mute.png)',
						  'background-size': '100% 100%'
					   });
					   intensity.hide();
					} else {
					   video[0].muted = false;
					   volume.css({
						  'background': 'url(https://1.bp.blogspot.com/-scGPe7XjFOY/XIlOsP415BI/AAAAAAAAM-k/yBKpO8qvJ_kYXBJVUNCxLhjWLu31QI4mACK4BGAYYCw/s1600/volume.png)',
						  'background-size': '100% 100%'
					   });
					   intensity.show();
					}
